...
export default function DashboardUser() {
  ...
  const sortedWork = artworkDatas?.sort(
      ...
      <Box
            ...
            <div className="headertab">
              <Box sx={{ borderBottom: 1, borderColor: "divider" }}>
                <Tabs
                  ...
                  TabIndicatorProps={{ style: { backgroundColor: theme.color } }} // Set the indicator color
                  sx={{
                    "& .MuiTab-root": {
                      color: theme.color2, // Set the color of the tabs
                    },
                    "& .Mui-selected": {
                      color: theme.color, // Set the color of the selected tab
                    },
                  }}>
            ...
            <CustomTabPanel value={value} index={0}>
              <div className="contentdashboard">
                ...
                <div className="explication" style={{ border: "1px solid", borderColor: theme.color3, height: "auto" }}>
                  <h3>
                    {" "}
                    <EditNoteIcon style={{ transform: "translateY(22%)" }} />
                    Featured Artworks:{" "}
                  </h3>
        ...
        <div className="contentoverview">
          ...
          <div className="overview" style={{ display: "flex", justifyContent: "space-around" }}>
            <div className="line">
              <Typography variant="h6" className="line1">
                {" "}
                Total commission received: {commissionRecieved.length}{" "}
              </Typography>
              <Typography variant="h6" className="line1">
                Total commission sent : {commissionSent.length}{" "}
              </Typography>
              <Typography variant="h6" className="line1">
                Your post number: {artworkDatas?.length}{" "}
              </Typography>
            </div>
            <div className="line">
              <Typography variant="h6" className="line1">
                Total number of likes: {totalLikes ?? 0}{" "}
              </Typography>
              <Typography variant="h6" className="line1">
                Number of works sold: TOBEADDED{" "}
              </Typography>
              <Typography variant="h6" className="line1">
                Number of works bought: TOBEADDED{" "}
              </Typography>
            </div>
          </div>
        </div>
