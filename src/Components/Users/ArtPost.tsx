        ...
        <div className="info-postwork">
          ...
          <div className="imgpost" style={{ backgroundColor: theme.hoverBackgroundColor }}>
            <img
              ...
              src={`data:image/jpeg;base64,${artwork?.imageFile}`}
            />
          </div>
            ...
            <div className="infor-user-post">
              <div className="avatar-user-post">
                <Stack direction="row" spacing={2}>
                  <Avatar src={`data:image/jpeg;base64,${creator?.profilePicture}`} sx={{ width: 50, height: 50 }} />
                </Stack>
              </div>
              ...
              <div style={{ margin: "auto 5px" }}>
                {artwork?.purchasable === true && status?.status === false ? (
                  <Chip
                    ...
                    onClick={handleOpen}
                    style={{ fontSize: "20px", padding: "20px", fontWeight: "600", backgroundColor: "#61dafb" }}
                  />
                ) : (
                  <Button
