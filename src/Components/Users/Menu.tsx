        ...
        <AppBar
          ...
          <Toolbar sx={{ display: "flex", justifyContent: "space-between" }}>
            ...
            <Box sx={{ display: "flex", alignItems: "center" }}>
              ...
              <Button onClick={user === null ? () => handleClick : () => disabledButtons()} color="inherit">
                <Link to={user !== null ? "artworkform" : ""}>
                  <h3 style={{ fontWeight: "normal" }}>Publish Your Works</h3>
                </Link>
              </Button>
              <CustomizedDropdown handleClickAsGuest={handleClick} user={user} pack={pack ?? null} />
            </Box>
          </Toolbar>
        </AppBar>
      </Box>
