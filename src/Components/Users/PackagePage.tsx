...
export default function PackagePage({ onCurrentPackageChange }) {
    ...
    const [selectPackage, setSelectPackage] = useState<Package | undefined>(undefined);
    ...
    useEffect(() => {
        const getPackage = async () => {
            ...
            if (onCurrentPackageChange) onCurrentPackageChange(servicePackage);
            setLoading(false);
        };
        getPackage();
    ...
    const handleOpen = (pkg: Package) => {
        console.log("Opening dialog for package:", pkg);
    ...
    const handleClose = () => {
        ...
        setOpen(false);
        setSelectPackage(undefined);
    };

    const handlePackagePurchased = (newPackage: CurrentPackage) => {
        setCurrentPackage(newPackage);
        if (onCurrentPackageChange) onCurrentPackageChange(newPackage);
    };
    ...
    return (
        <div className="packagePage">
            ...
            <PackagePaymentConfirm
                ...
                item={selectPackage}
                onPackagePurchased={handlePackagePurchased}
            />
        </div>
    );
}